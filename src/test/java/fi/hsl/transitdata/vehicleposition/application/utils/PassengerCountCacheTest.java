...
public class PassengerCountCacheTest {
    ...
    public void testPassengerCountCache() {
        passengerCountCache.updatePassengerCount("1/1", "1", "2021-01-01", "12:00", "1", PassengerCount.Data.newBuilder()
                .setSchemaVersion(1)
                .setTopic("test")
                .setRandomizedVehicleLoadRatio(0.28)
        ...
        assertEquals(0.25, passengerCountCache.getPassengerCount("1/1", "1", "2021-01-01", "12:00", "1").getPayload().getVehicleCounts().getVehicleLoadRatio(), 0.00001);
    }
}
