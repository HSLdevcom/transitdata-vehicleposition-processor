...
public class StopStatusProcessorTest {
    ...
    private Hfp.Data generateHfpData(Hfp.Topic.EventType eventType, Hfp.Topic.TransportMode transportMode,
            String nextStop, String payloadStop) {
        ...
        return Hfp.Data.newBuilder().setSchemaVersion(1)
                .setTopic(Hfp.Topic.newBuilder().setSchemaVersion(1).setReceivedAt(0).setTopicPrefix("hfp")
                        ...
                        .setTemporalType(Hfp.Topic.TemporalType.ongoing).setTransportMode(transportMode)
                        .setOperatorId(1).setVehicleNumber(1).setUniqueVehicleId("1/1").setEventType(eventType)
    ...
    public void testCalculateStopStatus() {
        ...
        StopStatusProcessor.StopStatus stopStatus1 = calculator
                .getStopStatus(generateHfpData(Hfp.Topic.EventType.VP, "1", null));
        ...
        StopStatusProcessor.StopStatus stopStatus2 = calculator
                .getStopStatus(generateHfpData(Hfp.Topic.EventType.DUE, "1", "1"));
        ...
        StopStatusProcessor.StopStatus stopStatus3 = calculator
                .getStopStatus(generateHfpData(Hfp.Topic.EventType.VP, "1", "1"));
        ...
        StopStatusProcessor.StopStatus stopStatus4 = calculator
                .getStopStatus(generateHfpData(Hfp.Topic.EventType.ARS, "1", "1"));
        ...
        StopStatusProcessor.StopStatus stopStatus5 = calculator
                .getStopStatus(generateHfpData(Hfp.Topic.EventType.PDE, "2", "1"));
        ...
        StopStatusProcessor.StopStatus stopStatus6 = calculator
                .getStopStatus(generateHfpData(Hfp.Topic.EventType.VP, "2", null));
        ...
        StopStatusProcessor.StopStatus stopStatus7 = calculator
                .getStopStatus(generateHfpData(Hfp.Topic.EventType.PAS, "3", "2"));
    ...
    public void testStopStatusWithMetro() {
        ...
        StopStatusProcessor.StopStatus stoppedAtStop1 = processor
                .getStopStatus(generateHfpData(Hfp.Topic.EventType.VP, Hfp.Topic.TransportMode.metro, "1", "1"));
        ...
        StopStatusProcessor.StopStatus inTransitToStop2 = processor
                .getStopStatus(generateHfpData(Hfp.Topic.EventType.VP, Hfp.Topic.TransportMode.metro, "2", null));
