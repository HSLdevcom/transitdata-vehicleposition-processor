...
public class VehicleTimestampValidatorTest {
    ...
    public void testVehiclePositionWithTimestampInFutureIsIgnored() {
        Hfp.Data data = Hfp.Data.newBuilder().setSchemaVersion(1)
                .setTopic(Hfp.Topic.newBuilder().setSchemaVersion(1).setUniqueVehicleId("1/1").setReceivedAt(0)
                        .setTopicPrefix("hfp").setTopicVersion("v2").setJourneyType(Hfp.Topic.JourneyType.journey)
                        .setTemporalType(Hfp.Topic.TemporalType.ongoing).setOperatorId(1).setVehicleNumber(1))
                .setPayload(Hfp.Payload.newBuilder().setSchemaVersion(1).setTst("").setTsi(10)).build();
    ...
    public void testVehiclePositionWithOlderTimestampThanPreviousIsIgnored() {
        Hfp.Data data1 = Hfp.Data.newBuilder().setSchemaVersion(1)
                .setTopic(Hfp.Topic.newBuilder().setSchemaVersion(1).setUniqueVehicleId("1/1").setReceivedAt(0)
                        .setTopicPrefix("hfp").setTopicVersion("v2").setJourneyType(Hfp.Topic.JourneyType.journey)
                        .setTemporalType(Hfp.Topic.TemporalType.ongoing).setOperatorId(1).setVehicleNumber(1))
                .setPayload(Hfp.Payload.newBuilder().setSchemaVersion(1).setTst("").setTsi(10)).build();
        ...
        Hfp.Data data2 = Hfp.Data.newBuilder().setSchemaVersion(1)
                .setTopic(Hfp.Topic.newBuilder().setSchemaVersion(1).setUniqueVehicleId("1/1").setReceivedAt(0)
                        .setTopicPrefix("hfp").setTopicVersion("v2").setJourneyType(Hfp.Topic.JourneyType.journey)
                        .setTemporalType(Hfp.Topic.TemporalType.ongoing).setOperatorId(1).setVehicleNumber(1))
                .setPayload(Hfp.Payload.newBuilder().setSchemaVersion(1).setTst("").setTsi(9)).build();

        //Vehicle position is ignored
        assertFalse(validator.validateTimestamp(data2, 11500));

        Hfp.Data data3 = Hfp.Data.newBuilder().setSchemaVersion(1)
                .setTopic(Hfp.Topic.newBuilder().setSchemaVersion(1).setUniqueVehicleId("1/1").setReceivedAt(0)
                        .setTopicPrefix("hfp").setTopicVersion("v2").setJourneyType(Hfp.Topic.JourneyType.journey)
                        .setTemporalType(Hfp.Topic.TemporalType.ongoing).setOperatorId(1).setVehicleNumber(1))
                .setPayload(Hfp.Payload.newBuilder().setSchemaVersion(1).setTst("").setTsi(12)).build();
